...
if (Config.WORKTYPE == 'private') {
    ...
    SewRavi.addCommand({pattern: 'emo ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '𝙼𝚊𝚍𝚎 𝙱𝚢 𝙼𝚒𝚜𝚜 sulthan'})
    ...
    SewRavi.addCommand({pattern: 'png ?(.*)', fromMe: true,dontAddCMDList: true}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '𝙼𝚊𝚍𝚎 𝙱𝚢  SULTHAN'})
