...
sulthan.addCommand({pattern: 'filter ?(.*)', fromMe: true, desc: Lang.FILTER_DESC, dontAddCommandList: true}, (async (message, match) => {
...
Sulthan.addCommand({pattern: 'stop ?(.*)', fromMe: true, desc: Lang.STOP_DESC, dontAddCommandList: true}, (async (message, match) => {
    match = match[1].match(/[\'\"\â€œ](.*?)[\'\"\â€œ]/gsm);
    if (match === null) {
...
sulthan.addCommand({on: 'text', fromMe: false}, (async (message, match) => {
        if(Config.BGMFILTER){
...
sulthan.addCommand({on: 'text', fromMe: false,onlyGroup: true}, (async (message, match) => {
...
filtreler.map(
 ...
 sulthan.addCommand({on: 'text', fromMe: false, onlyPm: true}, (async (message, match) => {
